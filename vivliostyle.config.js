...
const def = {
  title: "kinoko2026", // populated into `publication.json`, default to `title` of the first entry or `name` in `package.json`.
  author: "きのこカンファレンス実行委員会 <kinoko@kinoko-conf.dev>", // default to `author` in `package.json` or undefined.
